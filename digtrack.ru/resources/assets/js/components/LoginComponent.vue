<template>
    <div>
        <div class="login-component-page" v-bind:style="{ backgroundImage: 'url(https://digtrack.ru/ui/bg.png)' }">
            <div class="row login_screen">
                <div class="col-md-4 offset-md-2" style="margin-top: 5%;">
                    <div class="card" style="border-radius: 15px;">
                        <a style="text-align: center;" href="/"><img height="70" class="m-4" src="https://digtrack.ru/ui/logo.svg" alt=""></a>
                            ...
                            <div class="form-horizontal" id="loginf">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-3">
                                                <img v-if="activeAvatar == 1" @click="setActiveAvatar(1)" class="active-ui-el"   src="https://digtrack.ru/avatars/1.png">
                                                <img v-if="activeAvatar != 1" @click="setActiveAvatar(1)" class="active-ui-el unactive-ui-el" src="https://digtrack.ru/avatars/1.png">
                                            </div>
                                            <div class="col-md-3">
                                                <img v-if="activeAvatar == 2" @click="setActiveAvatar(2)" class="active-ui-el"   src="https://digtrack.ru/avatars/2.png">
                                                <img v-if="activeAvatar != 2" @click="setActiveAvatar(2)" class="active-ui-el unactive-ui-el" src="https://digtrack.ru/avatars/2.png">
                                            </div>
                                            <div class="col-md-3">
                                                <img v-if="activeAvatar == 3" @click="setActiveAvatar(3)" class="active-ui-el"   src="https://digtrack.ru/avatars/3.png">
                                                <img v-if="activeAvatar != 3" @click="setActiveAvatar(3)" class="active-ui-el unactive-ui-el" src="https://digtrack.ru/avatars/3.png">
                                            </div>
                                            <div class="col-md-3">
                                                <img v-if="activeAvatar == 4" @click="setActiveAvatar(4)" class="active-ui-el"   src="https://digtrack.ru/avatars/4.png">
                                                <img v-if="activeAvatar != 4" @click="setActiveAvatar(4)" class="active-ui-el unactive-ui-el" src="https://digtrack.ru/avatars/4.png">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-md-offset-4">                                        
                                        <center>
                                            <a v-if="!loginAccess" style="text-align: center;"                            class="unactive-ui-el"><img height="47" class="mt-2 mb-1" :src="'https://digtrack.ru/ui/login.svg'" alt=""></a>
                                            <a v-if="loginAccess"  style="text-align: center;" v-on:click="coonect2game"  class="active-ui-el">  <img height="47" class="mt-2 mb-1" :src="'https://digtrack.ru/ui/login.svg'" alt=""></a>
                                        </center>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4" style="margin-top: 5%;">
                    <div class="card" style="border-radius: 15px; height: 468px;">
                        <center><img height="70" class="m-4" src="https://digtrack.ru/ui/rating.svg" alt=""></center>
...
<script>
    export default {
        ...
        mounted(){
            axios.post('https://digtrack.ru/check', {
                key: this.roomId,
            ...
            axios.post('https://digtrack.ru/rating_list')
            .then((response) => {
                this.rating = response.data;
            });


            axios.post('https://digtrack.ru/key')
            .then((response) => {
        ...
        methods: {
            ...
            coonect2game(){
                axios.post('https://digtrack.ru/teams/connect', {
                    roomId: this.roomId,
                    name: this.name,
                ...
                .then((response) => {
                    if(response.data == 1){
                        window.location.href="https://digtrack.ru/rules/" + this.key;
                    }else{
                        this.bad_key = true;
                    }
